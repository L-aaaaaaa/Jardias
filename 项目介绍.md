...
> 演示说明文档（[library/演示场景.md](library/演示场景.md)）
> 真实运行输出（[logs/](logs/)）
> 实际运行录屏（链接）
> 差异对比：Jardias vs 主流框架（链接）
...
> 详细说明见 [运行和开发提示文档](doc/运行和开发提示.md)
...
| 文档 | 核心观点 | 解决的实际问题 |
|---|---|---|
| [HEEL](library/1.HEEL.md) | 记忆按加工状态分四层，而非按语义类型 | 为什么 Jardias 对话再多也不炸上下文 |
